#!/usr/bin/env python3
"""Utility helper for the pack-prompts skill.

This script keeps prompt-maintenance workflow discovery deterministic.
"""
...
REFERENCE_LINKS = [
    {
        ...
        'note': 'Frontmatter and deterministic formatting.',
    },
    {
        'title': 'OpenAI prompt engineering guide',
        'url': 'https://developers.openai.com/docs/guides/prompt-engineering',
        'note': 'Prompt contract clarity and instruction quality.',
    },
]
