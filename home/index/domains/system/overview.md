# System (domain router, overview)

Use this route when you need system (domain guidance, overview). Select the closest matching destination below, read only what the next action requires, and stop discovery when the implementation or check is clear.
...
- `$CODEX_HOME/index/domains/system/optimizations.md` — Host optimizations (entrypoint)
- `$CODEX_HOME/index/domains/system/sysctl.md` — sysctl (entrypoint)
- `$CODEX_HOME/index/domains/system/systemd.md` — systemd services workflow (entrypoint)
- `$CODEX_HOME/index/domains/system/usbguard.md` — USBGuard (entrypoint)
<!-- END:contents -->
...
Entry points:
- `$CODEX_HOME/index/domains/system/hardening.md` — stable link to OS-level hardening guidance (kernel, boot, sysctl, USB control).
...
- `$CODEX_HOME/index/domains/system/sysctl.md` — stable link to sysctl guidance.
- `$CODEX_HOME/index/domains/system/systemd.md` — stable link to systemd guidance.
- `$CODEX_HOME/index/domains/system/usbguard.md` — stable link to USBGuard guidance.
