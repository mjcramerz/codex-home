...
description: Use this skill for capture conversations and decisions into structured Obsidian notes. Use when converting chats, specs, or notes into reusable knowledge artifacts inside an Obsidian vault.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#CC6332'
  default-prompt: Act as the "OBSIDIAN-Knowledge Capture" specialist for "Obsidian knowledge capture workflows". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
