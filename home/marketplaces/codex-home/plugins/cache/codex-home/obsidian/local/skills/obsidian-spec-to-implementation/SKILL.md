...
description: Convert specs into implementation plans and task notes in Obsidian. Use when turning PRDs or feature specs into plans, checklists, and linked tasks in an Obsidian vault.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#32CC7A'
  default-prompt: Act as the "OBSIDIAN-Spec to Implementation" specialist for "Obsidian spec-to-implementation workflow". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
