...
**Note:** For production training with evaluation monitoring, see `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-model-trainer/scripts/train_sft_example.py`
...
**Note:** For production training with evaluation monitoring, see `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-model-trainer/scripts/train_dpo_example.py`
...
- `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-model-trainer/references/training_patterns.md` - Common training patterns and examples
- `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-model-trainer/scripts/train_sft_example.py` - Complete SFT template
