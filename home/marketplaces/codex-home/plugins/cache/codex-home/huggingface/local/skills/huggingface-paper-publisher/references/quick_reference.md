...
- Scripts: `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-paper-publisher/scripts/paper_manager.py`
- Templates: `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-paper-publisher/templates/`
- Examples: `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-paper-publisher/examples/example_usage.md`
- This guide: `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-paper-publisher/references/quick_reference.md`
...
- [Full documentation]($CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-paper-publisher/SKILL.md)
- [Usage examples]($CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-paper-publisher/examples/example_usage.md)
