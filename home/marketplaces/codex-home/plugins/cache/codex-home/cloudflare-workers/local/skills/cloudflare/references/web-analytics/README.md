...
- [GraphQL Analytics API Reference]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/graphql-api/) - Query server-side analytics (HTTP, Workers, DNS, Firewall, etc.) via GraphQL
