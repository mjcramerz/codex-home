...
For design patterns, HA architecture, and security best practices, see [patterns.md]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/network-interconnect/patterns.md).
