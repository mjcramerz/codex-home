...
- [Configuration]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workers/configuration.md) - wrangler.jsonc setup, bindings, environments
- [API]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workers/api.md) - Runtime APIs, bindings, execution context
- [Patterns]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workers/patterns.md) - Common workflows, testing, optimization
...
- [Gotchas]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workers/gotchas.md) - Common issues, limits, troubleshooting
...
- [KV]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/kv/README.md) - Key-value storage
- [D1]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/d1/README.md) - SQL database
- [R2]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/r2/README.md) - Object storage
- [Durable Objects]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/durable-objects/README.md) - Stateful coordination
- [Queues]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/queues/README.md) - Message queues
- [Wrangler]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/wrangler/README.md) - CLI tool reference
