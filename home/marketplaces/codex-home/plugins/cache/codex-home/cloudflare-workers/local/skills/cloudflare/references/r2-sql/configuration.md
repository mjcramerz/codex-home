...
- [r2-data-catalog/configuration.md]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/r2-data-catalog/configuration.md) - Detailed token setup and PyIceberg connection
