...
For design patterns, HA architecture, and security best practices, see [patterns.md]($CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/network-interconnect/patterns.md).
