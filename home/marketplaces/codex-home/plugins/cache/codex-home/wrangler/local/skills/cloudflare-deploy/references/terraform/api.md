...
- [Patterns]($CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/terraform/patterns.md) - Architecture patterns
- [Troubleshooting]($CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/terraform/gotchas.md) - Common issues
