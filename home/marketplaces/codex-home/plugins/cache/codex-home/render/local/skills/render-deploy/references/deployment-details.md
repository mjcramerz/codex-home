...
- Node.js Express: [$CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/node-express.yaml]($CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/node-express.yaml)
- Next.js + Postgres: [$CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/nextjs-postgres.yaml]($CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/nextjs-postgres.yaml)
- Django + Worker: [$CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/python-django.yaml]($CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/python-django.yaml)
- Static Site: [$CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/static-site.yaml]($CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/static-site.yaml)
- Go API: [$CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/go-api.yaml]($CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/go-api.yaml)
- Docker: [$CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/docker.yaml]($CODEX_HOME/plugins/cache/codex-home/render/local/skills/render-deploy/assets/docker.yaml)
