...
Consult this reference when infra-containers reference bundle is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.
...
- `$CODEX_HOME/plugins/containers/skills/infra-containers/SKILL.md`
- `$CODEX_HOME/plugins/containers/skills/infra-containers/agents/openai.yaml`
