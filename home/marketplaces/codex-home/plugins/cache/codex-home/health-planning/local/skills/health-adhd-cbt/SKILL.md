...
description: Use this skill for comprehensive ADHD planning and CBT-based (sometimes requested as "CBD") daily templates with PDF generation workflows. Use when generating printable ADHD/CBT worksheets, daily planners, impulse-control decision filters, emotion regulation check-ins, or when converting template content to PDF/HTML using the bundled scripts and assets.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#4F32CC'
  default-prompt: Act as the "HEALTH-ADHD & CBT" specialist for "ADHD + CBT daily planning PDF templates". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
