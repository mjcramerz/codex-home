...
description: Use this skill for research across Notion and synthesize into structured documentation; use when gathering info from multiple Notion sources to produce briefs, comparisons, or reports with citations.
metadata:
  version: '1.0'
  ...
  - reports
interface:
  display-name: NOTION-Research Docs
  short-description: Research Notion content and produce briefs/reports
  icon-small: assets/icon-32.png
  icon-large: assets/icon-128.png
  brand-color: '#32CC9B'
  default-prompt: Act as the "NOTION-Research Docs" specialist for "Research Notion content and produce briefs/reports". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
...
- synthesizing findings from multiple Notion sources into a single report
- producing research briefs, comparisons, or evidence-backed documentation
- organizing references and citations for downstream implementation work
