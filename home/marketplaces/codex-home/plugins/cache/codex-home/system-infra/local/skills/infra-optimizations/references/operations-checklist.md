---
title: Operations checklist for infra-optimizations
status: active
...
# Operations checklist for infra-optimizations

Consult this reference when operations checklist for infra-optimizations is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.

## Objective

Keep infra optimizations work deterministic, reversible, and security-aware.
