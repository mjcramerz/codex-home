---
name: infra-sysctl
description: Apply kernel sysctl parameter changes with safe rollout, verification, and rollback guidance. Use when the user asks to tune /proc/sys values or persistent sysctl settings.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#32CC54'
  default-prompt: Act as the "INFRA-sysctl" specialist for "Apply sysctl tuning with safety and rollback". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
...
- `$CODEX_HOME/plugins/system-infra/skills/infra-sysctl/references/latest-sources.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-sysctl/references/operations-checklist.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-sysctl/references/risk-register.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-sysctl/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-sysctl/scripts/skill_helper.py`
