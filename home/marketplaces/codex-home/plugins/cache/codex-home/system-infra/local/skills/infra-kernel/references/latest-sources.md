...
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/local/skills/infra-kernel/SKILL.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/local/skills/infra-kernel/agents/openai.yaml`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/local/skills/infra-kernel/scripts/skill_helper.py`
