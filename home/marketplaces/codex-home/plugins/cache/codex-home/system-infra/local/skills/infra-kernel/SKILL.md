---
name: infra-kernel
description: Build and validate custom Linux kernel configurations with reproducible compile and boot validation steps. Use when the user asks for custom kernel config, compile, or test guidance.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#CC3296'
  default-prompt: Act as the "INFRA-Kernel" specialist for "Plan and validate custom Linux kernel builds". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
