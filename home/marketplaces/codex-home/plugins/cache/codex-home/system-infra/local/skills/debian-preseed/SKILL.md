...
- `$CODEX_HOME/plugins/system-infra/skills/debian-preseed/references/latest-sources.md`
- `$CODEX_HOME/plugins/system-infra/skills/debian-preseed/scripts/skill_helper.py`
