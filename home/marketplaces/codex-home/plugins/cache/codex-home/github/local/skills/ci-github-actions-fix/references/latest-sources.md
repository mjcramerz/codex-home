...
Consult this reference when ci-github-actions-fix reference bundle is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.
...
- Workflow
- Bundled Resources
- `$CODEX_HOME/plugins/github/skills/ci-github-actions-fix/scripts/inspect_pr_checks.py`
- Agent orchestration
...
- `$CODEX_HOME/plugins/github/skills/ci-github-actions-fix/SKILL.md`
- `$CODEX_HOME/plugins/github/skills/ci-github-actions-fix/agents/openai.yaml`
