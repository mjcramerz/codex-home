...
- `$CODEX_HOME/plugins/desktop-wayland/skills/crystal-dock/references/latest-sources.md`
- `$CODEX_HOME/plugins/desktop-wayland/skills/crystal-dock/scripts/skill_helper.py`
