...
description: Configure a minimal Wayland plus Labwc desktop stack with secure defaults and predictable startup behavior. Use when the user asks for Wayland/Labwc session setup or troubleshooting.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#32CCA8'
  default-prompt: Act as the "DESKTOP-Wayland" specialist for "Configure a minimal Wayland/Labwc desktop stack". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
