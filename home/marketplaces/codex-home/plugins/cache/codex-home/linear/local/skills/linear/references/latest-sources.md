---
title: pm-linear-issues reference bundle
status: active
...
- `$CODEX_HOME/plugins/cache/codex-home/linear/local/skills/linear/SKILL.md`
- `$CODEX_HOME/plugins/cache/codex-home/linear/local/skills/linear/agents/openai.yaml`
