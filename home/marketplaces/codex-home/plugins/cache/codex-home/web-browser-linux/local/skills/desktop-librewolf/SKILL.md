---
name: desktop-librewolf
description: Configure LibreWolf with hardened privacy and security defaults for day-to-day desktop usage. Use when the user explicitly asks for LibreWolf setup or policy tuning.
metadata:
  version: '1.0'
  short-description: Configure LibreWolf with hardened defaults
  tags:
  - librewolf
  - browser
  - privacy
interface:
  display-name: DESKTOP-LibreWolf
  short-description: Configure LibreWolf with hardened defaults
  icon-small: assets/icon-32.png
  icon-large: assets/icon-128.png
  brand-color: '#6BCC32'
  default-prompt: Act as the "DESKTOP-LibreWolf" specialist for "Configure LibreWolf with hardened defaults". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
...
- setting LibreWolf overrides or policies
- wiring Wayland launch flags

## Workflow

1. Confirm install provenance
2. Apply overrides/policies
3. Validate profile permissions
