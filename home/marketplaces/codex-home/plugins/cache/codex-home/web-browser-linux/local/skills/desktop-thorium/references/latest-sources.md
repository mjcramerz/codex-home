...
Consult this reference when desktop-thorium reference bundle is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.
...
- `$CODEX_HOME/plugins/web-browser-linux/skills/desktop-thorium/SKILL.md`
- `$CODEX_HOME/plugins/web-browser-linux/skills/desktop-thorium/agents/openai.yaml`
