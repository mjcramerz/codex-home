# CLI reference (`$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/speech/scripts/text_to_speech.py`)
...
- **Never modify** `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/speech/scripts/text_to_speech.py`. If something is missing, ask the user before doing anything else.
...
## See also
- API parameter quick reference: `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/speech/references/audio-api.md`
- Instruction patterns and examples: `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/speech/references/voice-directions.md`
