...
Reproduce the failure safely, distinguish hypotheses from observations, and instrument the smallest relevant boundary. Remove temporary diagnostics unless requested.
