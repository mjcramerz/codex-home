...
Use this guide when the task concerns workflow: build an app (end-to-end). Apply the relevant steps to the current repository, preserve unrelated work, and stop when the requested outcome and checks are complete.
