...
Use this guide when the task concerns host optimizations workflow. Apply the relevant steps to the current repository, preserve unrelated work, and stop when the requested outcome and checks are complete.
...
- When executing, provide parameter diffs, benchmark evidence, and keep/rollback decision.
