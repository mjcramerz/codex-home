...
description: Harden desktop browser configurations, profile policies, and privacy/security defaults across managed endpoints. Use when the user asks to lock down browser settings or deploy browser hardening baselines.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#7032CC'
  default-prompt: Act as the "DESKTOP-Browser Hardening" specialist for "Harden desktop browsers and profile policies". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
