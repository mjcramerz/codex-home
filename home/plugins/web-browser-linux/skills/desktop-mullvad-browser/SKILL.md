...
description: Configure Mullvad Browser safely with privacy-preserving defaults and operational guardrails. Use when the user asks for Mullvad Browser installation, configuration, or hardening.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#93CC32'
  default-prompt: Act as the "DESKTOP-Mullvad Browser" specialist for "Configure Mullvad Browser safely". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
