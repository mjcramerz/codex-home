...
## Local resources
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-sysctl/references/latest-sources.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-sysctl/references/operations-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-sysctl/references/risk-register.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-sysctl/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-sysctl/scripts/skill_helper.py`
