...
## Local resources
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/storage-filesystems/references/latest-sources.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/storage-filesystems/references/operations-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/storage-filesystems/references/risk-register.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/storage-filesystems/assets/rollback-checklist.md`
