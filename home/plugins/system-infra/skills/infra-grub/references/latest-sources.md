...
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-grub/SKILL.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-grub/agents/openai.yaml`
