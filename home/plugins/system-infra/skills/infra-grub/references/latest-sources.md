...
Consult this reference when infra-grub reference bundle is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.
...
- `$CODEX_HOME/plugins/system-infra/skills/infra-grub/SKILL.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-grub/agents/openai.yaml`
