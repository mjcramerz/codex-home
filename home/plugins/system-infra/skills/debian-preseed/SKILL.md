...
## Local resources
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/debian-preseed/references/latest-sources.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/debian-preseed/scripts/skill_helper.py`
