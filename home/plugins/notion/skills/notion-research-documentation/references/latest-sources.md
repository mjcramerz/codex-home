...
Consult this reference when notion-research-documentation reference bundle is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.
...
- `$CODEX_HOME/plugins/notion/skills/notion-research-documentation/SKILL.md`
- `$CODEX_HOME/plugins/notion/skills/notion-research-documentation/agents/openai.yaml`
- `$CODEX_HOME/plugins/notion/skills/notion-research-documentation/reference/` (previous notes retained by this skill)
