...
- `$CODEX_HOME/plugins/cache/codex-home/notion/1.0.0/skills/notion-knowledge-capture/SKILL.md`
- `$CODEX_HOME/plugins/cache/codex-home/notion/1.0.0/skills/notion-knowledge-capture/agents/openai.yaml`
- `$CODEX_HOME/plugins/cache/codex-home/notion/1.0.0/skills/notion-knowledge-capture/reference/` (previous notes retained by this skill)
