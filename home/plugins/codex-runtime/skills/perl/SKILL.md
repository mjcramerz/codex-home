---
name: perl
description: Use this skill for write and review Perl for deterministic runtime helpers, CLI tools, and data transforms with strict validation and minimal shell exposure. Use when the user asks about Perl code beyond hook-specific modules.
metadata:
  version: '1.0'
...
- `$CODEX_HOME/plugins/codex-runtime/skills/perl/references/latest-sources.md`
- `$CODEX_HOME/plugins/codex-runtime/skills/perl/scripts/skill_helper.py`
