...
| Skill | Apply it to |
| --- | --- |
| [stripe-billing-ops](skills/stripe-billing-ops/SKILL.md) | Use this skill for stripe billing operations, invoicing, and customer-impact reviews. |
| [stripe-payments](skills/stripe-payments/SKILL.md) | Use this skill for stripe payment flows, checkout, subscriptions, and webhooks. |
