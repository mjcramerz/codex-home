...
| Skill | Apply it to |
| --- | --- |
| [infra-containers](skills/infra-containers/SKILL.md) | Design and operate container workflows across Docker/Podman/Compose/Buildx/Buildah with explicit network and runtime safety controls |
