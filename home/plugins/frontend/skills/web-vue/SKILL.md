---
name: web-vue
description: Build Vue applications with Composition API patterns, state-flow discipline, and reusable component boundaries. Use when the user asks for Vue component logic, composables, and client-side architecture outside Nuxt-specific SSR/runtime concerns.
metadata:
  version: '1.0'
