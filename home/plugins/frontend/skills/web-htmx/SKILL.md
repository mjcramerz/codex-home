---
name: web-htmx
description: Build server-driven HTMX interfaces with progressive enhancement, explicit fragment contracts, and minimal custom JavaScript. Use when the user asks for HTMX flows, partial swaps, or hypermedia-style frontend behavior.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#CC6D32'
  default-prompt: Act as the "WEB-HTMX" specialist for "Build server-driven HTMX pages with minimal JS". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
