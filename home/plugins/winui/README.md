...
| Skill | Apply it to |
| --- | --- |
| [winui-app](skills/winui-app/SKILL.md) | Use this skill for bootstrap, develop, and design modern WinUI 3 desktop applications with C# and the Windows App SDK using official Microsoft guidance, WinUI Gallery patterns, Windows App SDK samples, and CommunityToolkit components |
