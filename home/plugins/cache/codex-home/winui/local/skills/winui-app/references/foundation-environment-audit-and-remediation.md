...
1. Use the setup-and-scaffold flow in [$CODEX_HOME/plugins/cache/codex-home/winui/local/skills/winui-app/SKILL.md]($CODEX_HOME/plugins/cache/codex-home/winui/local/skills/winui-app/SKILL.md) for environment readiness, remediation, and initial verification.
