---
title: Operations checklist for iac-terraform
status: active
...
# Operations checklist for iac-terraform

Consult this reference when operations checklist for iac-terraform is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.

## Objective

Keep iac terraform work deterministic, reversible, and security-aware.
