...
## Local resources
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/references/latest-sources.md`
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/references/operations-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/references/risk-register.md`
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/scripts/skill_helper.py`
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/references/domain-xml-guardrails.md`
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/references/storage-network-playbook.md`
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/assets/domain-template.xml`
- `$CODEX_HOME/plugins/cache/codex-home/virtualization/local/skills/infra-virsh/assets/network-template.xml`
