...
description: Design VM-based virtualization using QEMU/KVM/libvirt and Vagrant with reproducible network and storage layout. Use when the user asks for hypervisor-agnostic VM architecture or local VM dev environment setup.
metadata:
  version: '1.0'
  short-description: 'VM-based virtualization workflows: QEMU/KVM/libvirt, Vagrant, networking modes, and reproducible dev environments'
  tags:
  - virtualization
  - libvirt
  - qemu
...
interface:
  ...
  brand-color: '#CBCC32'
  default-prompt: 'Act as the "INFRA-Virtualization" specialist for "VM-based virtualization workflows: QEMU/KVM/libvirt, Vagrant, networking modes, and reproducible dev environments". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.'
---
...
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/references/latest-sources.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/references/operations-checklist.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/references/risk-register.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/scripts/skill_helper.py`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/references/networking-modes.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/references/provider-decision-matrix.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/assets/Vagrantfile.template`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virtualization/assets/topology.template.yaml`
