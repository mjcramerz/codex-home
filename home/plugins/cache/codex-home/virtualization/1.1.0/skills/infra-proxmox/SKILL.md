---
name: infra-proxmox
description: Operate Proxmox VE virtual machines, storage, and networking with cluster-safe procedures. Use when the user asks for Proxmox-specific VM tasks rather than generic libvirt tooling.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#CC7A32'
  default-prompt: Act as the "INFRA-Proxmox" specialist for "Plan Proxmox VM workflows with storage and network safety". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
...
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/references/latest-sources.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/references/operations-checklist.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/references/risk-register.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/scripts/skill_helper.py`
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/references/cloud-init-golden-image.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/references/proxmox-cluster-ops.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/assets/cloud-init-user-data.template.yaml`
- `$CODEX_HOME/plugins/virtualization/skills/infra-proxmox/assets/vm-spec.template.yaml`
