...
- **[API]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/durable-objects/api.md)** - ctx methods, WebSocket handlers
- **[Gotchas]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/durable-objects/gotchas.md)** - Hibernation caveats, common errors
- **[DO Storage]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/do-storage/README.md)** - Storage patterns and transactions
