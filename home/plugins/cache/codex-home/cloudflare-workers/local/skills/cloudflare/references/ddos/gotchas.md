...
See [patterns.md]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/ddos/patterns.md) for progressive rollout examples.
