...
See [README.md]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/README.md), [configuration.md]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/configuration.md), [api.md]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/api.md), [patterns.md]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/patterns.md)
