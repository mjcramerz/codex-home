...
- [Durable Objects]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/durable-objects/) - Containers extend Durable Objects
- [Workflows]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/workflows/) - Orchestrate container operations
- [Queues]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/queues/) - Trigger containers from queue messages
