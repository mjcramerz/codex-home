...
- **[API]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/durable-objects/api.md)** - ctx methods, WebSocket handlers
- **[Gotchas]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/durable-objects/gotchas.md)** - Hibernation caveats, common errors
- **[DO Storage]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/do-storage/README.md)** - Storage patterns and transactions
