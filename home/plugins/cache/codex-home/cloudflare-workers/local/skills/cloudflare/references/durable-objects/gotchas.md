...
**Solution:** Shard across multiple DOs (see [Patterns: Sharding]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/durable-objects/patterns.md))
...
- **[Patterns]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/durable-objects/patterns.md)** - Workarounds for common limitations
- **[API]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/durable-objects/api.md)** - Storage limits and quotas
- **[Configuration]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/local/skills/cloudflare/references/durable-objects/configuration.md)** - Setting CPU limits
