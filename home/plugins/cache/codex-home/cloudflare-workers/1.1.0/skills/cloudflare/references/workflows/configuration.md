...
See: [api.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workflows/api.md), [patterns.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workflows/patterns.md)
