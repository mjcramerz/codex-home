...
- [GraphQL Analytics API Reference]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/graphql-api/) - Query server-side analytics (HTTP, Workers, DNS, Firewall, etc.) via GraphQL
