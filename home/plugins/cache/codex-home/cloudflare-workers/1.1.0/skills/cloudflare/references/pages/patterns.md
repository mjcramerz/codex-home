...
For deprecated frameworks, see [gotchas.md]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/pages/gotchas.md#framework-specific) for migration options.
