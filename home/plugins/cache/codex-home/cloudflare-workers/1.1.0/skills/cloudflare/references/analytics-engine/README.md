...
- [GraphQL Analytics API Reference]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/graphql-api/) - Query built-in Cloudflare analytics (HTTP, Workers, DNS, Firewall, etc.)
- [Observability Reference]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/observability/) - Workers Logs, Traces, and real-time debugging
