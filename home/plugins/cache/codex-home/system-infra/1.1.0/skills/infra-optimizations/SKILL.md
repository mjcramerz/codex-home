...
description: Use this skill for tune host performance and security settings with measurement-first baselines and rollback controls. Use when the user asks to improve host throughput, latency, or system hardening posture.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#BCCC32'
  default-prompt: Act as the "INFRA-Optimizations" specialist for "Plan host performance/security tuning with measurement and rollback". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
...
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/references/latest-sources.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/references/operations-checklist.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/references/risk-register.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/scripts/skill_helper.py`
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/references/perf-experiment-template.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/references/tuning-rollback-matrix.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/assets/experiment-sheet.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-optimizations/assets/sysctl-rollback.conf`
