---
title: Operations checklist for perf-profiling
status: active
...
# Operations checklist for perf-profiling

Consult this reference when operations checklist for perf-profiling is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.

## Objective

Keep perf profiling work deterministic, reversible, and security-aware.
