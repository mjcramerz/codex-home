...
- `$CODEX_HOME/plugins/system-infra/skills/os-debian-preseed/references/latest-sources.md`
- `$CODEX_HOME/plugins/system-infra/skills/os-debian-preseed/references/operations-checklist.md`
- `$CODEX_HOME/plugins/system-infra/skills/os-debian-preseed/references/risk-register.md`
- `$CODEX_HOME/plugins/system-infra/skills/os-debian-preseed/assets/rollback-checklist.md`
