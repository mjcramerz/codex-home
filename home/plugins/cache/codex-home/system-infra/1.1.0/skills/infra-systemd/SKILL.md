---
name: infra-systemd
description: Use this skill for design, harden, and validate systemd services and timers including unit files, restart behavior, and sandbox directives. Use when the user asks to create or troubleshoot Linux service/timer units.
metadata:
  version: '1.0'
  short-description: Design and harden systemd services and timers with safe defaults, validation, and install steps
  tags:
  - systemd
  - services
  - timers
...
interface:
  ...
  brand-color: '#5932CC'
  default-prompt: Act as the "INFRA-systemd" specialist for "Design and harden systemd services and timers with safe defaults, validation, and install steps". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
...
- `$CODEX_HOME/plugins/system-infra/skills/infra-systemd/references/latest-sources.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-systemd/references/operations-checklist.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-systemd/references/risk-register.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-systemd/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/system-infra/skills/infra-systemd/scripts/skill_helper.py`
