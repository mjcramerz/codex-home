...
## Local resources
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/local/skills/os-debian-preseed/references/latest-sources.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/local/skills/os-debian-preseed/references/operations-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/local/skills/os-debian-preseed/references/risk-register.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/local/skills/os-debian-preseed/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/local/skills/os-debian-preseed/scripts/skill_helper.py`
