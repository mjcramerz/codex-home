...
## Local resources
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-grub/references/latest-sources.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-grub/references/operations-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-grub/references/risk-register.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-grub/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/cache/codex-home/system-infra/1.0.0/skills/infra-grub/scripts/skill_helper.py`
