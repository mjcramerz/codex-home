...
## Where to find copy/paste recipes
For copy/paste instruction templates, see `$CODEX_HOME/plugins/cache/codex-home/ai-media/1.0.0/skills/speech/references/sample-prompts.md`. This file focuses on principles, structure, and iteration patterns.
