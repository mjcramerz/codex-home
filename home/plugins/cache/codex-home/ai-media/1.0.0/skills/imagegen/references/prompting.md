...
For copy/paste prompt specs (examples only), see `$CODEX_HOME/plugins/cache/codex-home/ai-media/1.0.0/skills/imagegen/references/sample-prompts.md`. This file focuses on principles, structure, and iteration patterns.
