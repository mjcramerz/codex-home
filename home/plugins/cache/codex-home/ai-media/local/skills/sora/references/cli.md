# CLI reference (`$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/sora/scripts/sora.py`)
...
- **Never modify** `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/sora/scripts/sora.py` unless the user asks.
...
## CLI notes
- Supported sizes depend on model (see `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/sora/references/video-api.md`).
...
## See also
- API parameter quick reference: `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/sora/references/video-api.md`
- Prompt structure and examples: `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/sora/references/prompting.md`
- Sample prompts: `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/sora/references/sample-prompts.md`
- Troubleshooting: `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/sora/references/troubleshooting.md`
