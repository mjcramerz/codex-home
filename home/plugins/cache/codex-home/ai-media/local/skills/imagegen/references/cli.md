# CLI reference (`$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/imagegen/scripts/image_gen.py`)
...
- **Never modify** `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/imagegen/scripts/image_gen.py`. If something is missing, ask the user before doing anything else.
...
## See also
- API parameter quick reference: `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/imagegen/references/image-api.md`
- Prompt examples: `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/imagegen/references/sample-prompts.md`
