...
For prompting principles (structure, invariants, iteration), see `$CODEX_HOME/plugins/cache/codex-home/ai-media/local/skills/imagegen/references/prompting.md`.
