...
description: Use this skill for capture conversations and decisions into structured Notion pages; use when turning chats/notes into wiki entries, how-tos, decisions, or FAQs with proper linking.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#32CCBA'
  default-prompt: Act as the "NOTION-Knowledge Capture" specialist for "Capture conversations into structured Notion pages". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
