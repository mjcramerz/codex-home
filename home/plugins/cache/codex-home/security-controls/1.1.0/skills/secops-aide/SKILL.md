---
name: secops-aide
description: Configure AIDE file-integrity monitoring rules, baselines, and scheduled verification runs. Use when the user asks for host file integrity monitoring or tamper-detection setup.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#32C9CC'
  default-prompt: Act as the "SECOPS-AIDE" specialist for "Configure AIDE file integrity monitoring". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
