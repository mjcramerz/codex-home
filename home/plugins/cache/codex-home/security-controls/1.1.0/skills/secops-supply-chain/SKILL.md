...
description: Harden software supply-chain controls through dependency pinning, lockfile discipline, SBOM generation, and CI enforcement. Use when the user asks about dependency risk, provenance, or package security posture.
metadata:
  version: '1.1'
  short-description: 'Strengthen dependency hygiene: pinning, lockfiles, audits, SBOMs, CI enforcement, and avoiding dangerous install patterns'
  tags:
  - supply-chain
  - security
  - dependencies
...
interface:
  ...
  brand-color: '#7732CC'
  default-prompt: 'Act as the "SECOPS-Supply Chain" specialist for "Strengthen dependency hygiene: pinning, lockfiles, audits, SBOMs, CI enforcement, and avoiding dangerous install patterns". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.'
---
