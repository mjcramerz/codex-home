---
title: devtools-app-scaffolder reference bundle
status: active
owner: Matthew Cramer
tags:
- skills
- all
- devtools-app-scaffolder
- references
- latest-sources-md
- latest-sources
- user
...
- `$CODEX_HOME/plugins/cache/codex-home/backend/local/skills/devtools-app-scaffolder/SKILL.md`
- `$CODEX_HOME/plugins/cache/codex-home/backend/local/skills/devtools-app-scaffolder/agents/openai.yaml`
...
- [PyPI packaging guide](https://packaging.python.org/en/latest/tutorials/packaging-projects/) - Python package scaffolding baseline.
