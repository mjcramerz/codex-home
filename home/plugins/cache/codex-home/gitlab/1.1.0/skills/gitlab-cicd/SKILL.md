---
name: gitlab-cicd
description: Use this skill for author and review GitLab CI/CD pipelines that stay thin over shared include contracts, protected refs, runner tags, and release-safe variable policies. Use when the user asks about .gitlab-ci.yml structure, include boundaries, or GitLab delivery hardening.
metadata:
  version: '1.0'
...
- `$CODEX_HOME/plugins/gitlab/skills/gitlab-cicd/references/latest-sources.md`
- `$CODEX_HOME/plugins/gitlab/skills/gitlab-cicd/scripts/skill_helper.py`
