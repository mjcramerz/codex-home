...
These events require ICE restart (see [patterns.md]($CODEX_HOME/plugins/cache/codex-home/wrangler/1.0.0/skills/cloudflare-deploy/references/turn/patterns.md#ice-restart-pattern)):
