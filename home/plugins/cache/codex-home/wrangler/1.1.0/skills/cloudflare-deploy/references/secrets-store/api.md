...
See: [configuration.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/secrets-store/configuration.md), [patterns.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/secrets-store/patterns.md), [gotchas.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/secrets-store/gotchas.md)
