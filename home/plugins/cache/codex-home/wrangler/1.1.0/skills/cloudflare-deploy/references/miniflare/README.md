...
3. [patterns.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/miniflare/patterns.md) - Testing patterns (getPlatformProxy, Vitest, node:test)
4. [configuration.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/miniflare/configuration.md) - Configure bindings, storage, multiple workers

**Troubleshooting:**
- [gotchas.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/miniflare/gotchas.md) - Common errors and debugging

**API reference:**
- [api.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/miniflare/api.md) - Complete method reference

## See Also

- [wrangler]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/wrangler/) - CLI tool that embeds Miniflare for `wrangler dev`
- [workerd]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/workerd/) - Runtime that powers Miniflare
- [workers]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/workers/) - Workers runtime API documentation
