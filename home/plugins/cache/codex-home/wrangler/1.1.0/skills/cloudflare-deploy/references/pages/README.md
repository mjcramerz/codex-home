...
2. [configuration.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages/configuration.md) - Project setup, wrangler.jsonc, bindings
3. [api.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages/api.md) - Functions API, routing, context
4. [patterns.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages/patterns.md) - Common implementations
5. [gotchas.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages/gotchas.md) - Troubleshooting & pitfalls

**Quick reference?** Jump to relevant file above.

## In This Reference

- [configuration.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages/configuration.md) - wrangler.jsonc, build, env vars, Smart Placement
- [api.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages/api.md) - Functions API, bindings, context, advanced mode
- [patterns.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages/patterns.md) - Full-stack patterns, framework integration
- [gotchas.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages/gotchas.md) - Build issues, limits, debugging, framework warnings

## See Also

- [pages-functions]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/pages-functions/) - File-based routing, middleware
- [d1]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/d1/) - SQL database for Pages Functions
- [kv]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/kv/) - Key-value storage for caching/state
