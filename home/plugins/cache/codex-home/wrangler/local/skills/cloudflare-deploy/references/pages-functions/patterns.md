...
**See also:** [api.md]($CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/pages-functions/api.md) for `env.ASSETS.fetch()` | [gotchas.md]($CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/pages-functions/gotchas.md) for debugging
