...
├─ From Workers runtime → Use bindings, not REST API (see $CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/bindings/)
├─ Server-side (Node/Python/Go) → Official SDK (see api.md)
├─ CLI/scripts → Wrangler or curl (see configuration.md)
├─ Infrastructure-as-code → See $CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/pulumi/ or $CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/terraform/
...
| Product-specific APIs | $CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/workers/, $CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/r2/, $CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/kv/, etc. |
...
- [Bindings Reference]($CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/bindings/) - Workers runtime bindings (preferred over REST API)
- [Wrangler Reference]($CODEX_HOME/plugins/cache/codex-home/wrangler/local/skills/cloudflare-deploy/references/wrangler/) - CLI tool for Cloudflare development
