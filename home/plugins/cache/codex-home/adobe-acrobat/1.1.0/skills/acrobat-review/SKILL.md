---
name: acrobat-review
description: Use Adobe Acrobat to compare PDF revisions, manage comments, and package document review outputs for collaborators.
metadata:
  version: '1.0'
  short-description: Acrobat PDF compare and review workflow
  tags:
  - plugin
  - acrobat
  - pdf
