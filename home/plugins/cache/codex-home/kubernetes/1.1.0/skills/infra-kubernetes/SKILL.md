...
description: Create and validate Kubernetes manifests, workload configs, and cluster operation patterns with secure defaults. Use when the user asks for Kubernetes YAML, deployment troubleshooting, or k8s hardening.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#32CC63'
  default-prompt: Act as the "INFRA-Kubernetes" specialist for "Build and validate Kubernetes manifests with safe defaults". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
...
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/references/latest-sources.md`
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/references/operations-checklist.md`
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/references/risk-register.md`
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/scripts/skill_helper.py`
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/references/rollout-runbook.md`
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/references/workload-security-baseline.md`
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/assets/deployment-baseline.yaml`
- `$CODEX_HOME/plugins/kubernetes/skills/infra-kubernetes/assets/networkpolicy-default-deny.yaml`
