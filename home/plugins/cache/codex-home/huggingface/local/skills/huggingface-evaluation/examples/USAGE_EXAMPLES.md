...
- `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-evaluation/SKILL.md` - Complete documentation
- `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-evaluation/SKILL.md` - Main workflow and troubleshooting guide
