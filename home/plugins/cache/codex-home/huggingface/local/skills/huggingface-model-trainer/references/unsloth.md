...
See `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-model-trainer/scripts/unsloth_sft_example.py` for a complete production-ready example that includes:
- Unsloth VLM setup
...
Run locally:
```bash
uv run $CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-model-trainer/scripts/unsloth_sft_example.py \
...
- `$CODEX_HOME/plugins/cache/codex-home/huggingface/local/skills/huggingface-model-trainer/scripts/unsloth_sft_example.py` - Complete text LLM training example
