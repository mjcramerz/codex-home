# Hosting Platforms task routing
...
| Skill | Apply it to |
| --- | --- |
| [hosting-platforms](skills/hosting-platforms/SKILL.md) | Use this skill for choose and coordinate deployment workflows across Vercel, Render, and Netlify |
