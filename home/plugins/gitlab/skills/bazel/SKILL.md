...
## Local resources
- `$CODEX_HOME/plugins/cache/codex-home/gitlab/1.0.0/skills/bazel/references/latest-sources.md`
- `$CODEX_HOME/plugins/cache/codex-home/gitlab/1.0.0/skills/bazel/scripts/skill_helper.py`
