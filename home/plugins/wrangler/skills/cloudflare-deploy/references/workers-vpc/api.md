...
See [patterns.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/workers-vpc/patterns.md) for multi-chunk reading, error handling, and protocol implementations.
...
- [patterns.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/workers-vpc/patterns.md) - Real-world protocol implementations
- [configuration.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/workers-vpc/configuration.md) - Wrangler setup and environment variables
- [gotchas.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/workers-vpc/gotchas.md) - Limits and error handling
