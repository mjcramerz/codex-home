...
**Use [Hyperdrive]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/hyperdrive/) for production.** Raw Postgres protocol is complex (startup, auth, query messages).
