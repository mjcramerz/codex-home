...
For deprecated frameworks, see [gotchas.md]($CODEX_HOME/plugins/cache/codex-home/wrangler/1.0.0/skills/cloudflare-deploy/references/pages/gotchas.md#framework-specific) for migration options.
