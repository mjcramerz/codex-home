...
See [README.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/hyperdrive/README.md), [configuration.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/hyperdrive/configuration.md), [api.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/hyperdrive/api.md), [patterns.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/hyperdrive/patterns.md).
...
**Solution:** Enable Smart Placement (`"placement": {"mode": "smart"}` in wrangler.jsonc) to execute Worker near DB. See [patterns.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/hyperdrive/patterns.md) Multi-Query pattern.
