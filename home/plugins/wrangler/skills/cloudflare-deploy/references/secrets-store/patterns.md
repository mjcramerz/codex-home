...
See: [workers]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/workers/) for service binding patterns.

See: [api.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/secrets-store/api.md), [gotchas.md]($CODEX_HOME/plugins/wrangler/skills/cloudflare-deploy/references/secrets-store/gotchas.md)
