...
| Skill | Apply it to |
| --- | --- |
| [infra-kubernetes](skills/infra-kubernetes/SKILL.md) | Create and validate Kubernetes manifests, workload configs, and cluster operation patterns with secure defaults |
