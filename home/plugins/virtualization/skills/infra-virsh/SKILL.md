---
name: infra-virsh
description: Manage libvirt and KVM virtual machines directly with virsh commands and XML-based domain control. Use when the user asks for virsh/libvirt operations outside Proxmox- managed environments.
metadata:
  version: '1.0'
...
interface:
  ...
  brand-color: '#32CC56'
  default-prompt: Act as the "INFRA-libvirt/virsh" specialist for "Manage libvirt/KVM workflows with virsh safely". Deliver focused, deterministic results with minimal, reviewable changes and explicit assumptions. Validate untrusted inputs and bounded I/O, run the narrowest relevant checks, and report concrete actions, evidence, and residual risks.
---
...
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/references/latest-sources.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/references/operations-checklist.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/references/risk-register.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/assets/rollback-checklist.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/scripts/skill_helper.py`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/references/domain-xml-guardrails.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/references/storage-network-playbook.md`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/assets/domain-template.xml`
- `$CODEX_HOME/plugins/virtualization/skills/infra-virsh/assets/network-template.xml`
