...
- **[API]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/durable-objects/api.md)** - ctx methods, WebSocket handlers
- **[Gotchas]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/durable-objects/gotchas.md)** - Hibernation caveats, common errors
- **[DO Storage]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/do-storage/README.md)** - Storage patterns and transactions
