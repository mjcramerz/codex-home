...
- [API]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/realtimekit/api.md) - Meeting APIs, REST endpoints
- [Patterns]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/realtimekit/patterns.md) - Backend integration examples
