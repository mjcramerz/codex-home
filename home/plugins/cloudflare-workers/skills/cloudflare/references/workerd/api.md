...
See [patterns.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workerd/patterns.md) for usage examples, [configuration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workerd/configuration.md) for config details.
