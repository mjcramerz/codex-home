...
**Solution:** Use [Hyperdrive]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/hyperdrive/) for databases (built-in pooling)
...
|----------|-------------|--------|
| PostgreSQL/MySQL | [Hyperdrive]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/hyperdrive/) | Connection pooling, caching |
...
- [Hyperdrive]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/hyperdrive/) - Database connections
- [Smart Placement]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/smart-placement/) - Latency optimization
- [Tunnel Troubleshooting]($CODEX_HOME/plugins/cache/codex-home/cloudflare-workers/1.0.0/skills/cloudflare/references/tunnel/gotchas.md)
