...
- [r2-data-catalog/configuration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/r2-data-catalog/configuration.md) - Detailed token setup and PyIceberg connection
