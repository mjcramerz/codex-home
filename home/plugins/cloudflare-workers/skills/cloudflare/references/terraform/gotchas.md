...
Consult this reference when terraform troubleshooting & best practices is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.
...
- [README]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/terraform/README.md) - Provider setup
- [Configuration]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/terraform/configuration.md) - Resources
- [API]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/terraform/api.md) - Data sources
- [Patterns]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/terraform/patterns.md) - Use cases
