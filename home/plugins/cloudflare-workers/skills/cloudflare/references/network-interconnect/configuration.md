...
For design patterns, HA architecture, and security best practices, see [patterns.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/network-interconnect/patterns.md).
