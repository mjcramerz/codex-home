...
Consult this reference when ddos gotchas is relevant to the selected task. Extract the specific constraint or example you need, verify version-sensitive behavior against the active toolchain, and return to the task rather than loading unrelated references.
...
See [patterns.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ddos/patterns.md) for progressive rollout examples.
