...
- **Using Vercel AI SDK** → Pattern 1 (recommended) - see [sdk-integration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/sdk-integration.md)
- **Using OpenAI SDK** → Pattern 2 - see [sdk-integration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/sdk-integration.md)
- **Cloudflare Worker + Workers AI** → Pattern 3 - see [sdk-integration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/sdk-integration.md)
- **Direct HTTP (any language)** → Pattern 4 - see [configuration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/configuration.md)
- **Framework (LangChain, etc.)** → See [sdk-integration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/sdk-integration.md)
...
| File | Purpose |
|------|---------|
| [sdk-integration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/sdk-integration.md) | Vercel AI SDK, OpenAI SDK, Workers binding patterns |
| [configuration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/configuration.md) | Dashboard setup, wrangler, API tokens |
| [features.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/features.md) | Caching, rate limits, guardrails, DLP, BYOK, unified billing |
| [dynamic-routing.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/dynamic-routing.md) | Fallbacks, A/B testing, conditional routing |
| [troubleshooting.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/troubleshooting.md) | Debugging, errors, observability, gotchas |

## Reading Order

| Task | Files |
|------|-------|
| First-time setup | README + [configuration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/configuration.md) |
| SDK integration | README + [sdk-integration.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/sdk-integration.md) |
| Enable caching | README + [features.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/features.md) |
| Setup fallbacks | README + [dynamic-routing.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/dynamic-routing.md) |
| Debug errors | README + [troubleshooting.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/ai-gateway/troubleshooting.md) |
...
- [Workers AI]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/workers-ai/README.md) - For `env.AI.run()` details
- [Agents SDK]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/agents-sdk/README.md) - For stateful AI patterns
- [Vectorize]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/vectorize/README.md) - For RAG patterns with embeddings
