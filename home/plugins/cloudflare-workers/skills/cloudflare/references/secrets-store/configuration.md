...
See: [api.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/secrets-store/api.md), [patterns.md]($CODEX_HOME/plugins/cloudflare-workers/skills/cloudflare/references/secrets-store/patterns.md)
