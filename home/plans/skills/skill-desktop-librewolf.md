# Desktop librewolf plan

Use this plan when you applying or updating the `desktop-librewolf` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `desktop-librewolf` skill.
...
- In: tasks covered by the `desktop-librewolf` skill and its resources.
...
- [ ] Use skill desktop-librewolf and linked resources.
...
- Example objective: "Apply the desktop-librewolf skill to the scoped repository task with explicit validation evidence."
