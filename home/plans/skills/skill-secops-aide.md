...
Use this plan when you applying or updating the `secops-aide` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `secops-aide` skill.
...
- In: tasks covered by the `secops-aide` skill and its resources.
...
- [ ] Use skill secops-aide and linked resources.
...
- Example objective: "Apply the secops-aide skill to the scoped repository task with explicit validation evidence."
