...
Use this plan when you applying or updating the `infra-grub` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `infra-grub` skill.
...
- In: tasks covered by the `infra-grub` skill and its resources.
...
- [ ] Use skill infra-grub and linked resources.
...
- Example objective: "Apply the infra-grub skill to the scoped repository task with explicit validation evidence."
