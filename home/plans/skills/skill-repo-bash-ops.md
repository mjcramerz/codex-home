...
Use this plan when you applying or updating the `repo-bash-ops` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.
...
- Read the `repo-bash-ops` skill only when its trigger matches this task and the skill is available.
...
- In: tasks covered by the `repo-bash-ops` skill and its resources.
...
- [ ] Use skill repo-bash-ops and linked resources.
...
- Example objective: "Apply the repo-bash-ops skill to the scoped repository task with explicit validation evidence."
