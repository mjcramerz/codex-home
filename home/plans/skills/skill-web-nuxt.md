...
Use this plan when you applying or updating the `web-nuxt` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `web-nuxt` skill.
...
- In: tasks covered by the `web-nuxt` skill and its resources.
...
- [ ] Use skill web-nuxt and linked resources.
...
- Example objective: "Apply the web-nuxt skill to the scoped repository task with explicit validation evidence."
