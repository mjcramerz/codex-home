...
Use this plan when you applying or updating the `web-html` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `web-html` skill.
...
- In: tasks covered by the `web-html` skill and its resources.
...
- [ ] Use skill web-html and linked resources.
...
- Example objective: "Apply the web-html skill to the scoped repository task with explicit validation evidence."
