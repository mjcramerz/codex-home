# Secops crowdsec plan

Use this plan when you applying or updating the `secops-crowdsec` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `secops-crowdsec` skill.
...
- In: tasks covered by the `secops-crowdsec` skill and its resources.
...
- [ ] Use skill secops-crowdsec and linked resources.
...
- Example objective: "Apply the secops-crowdsec skill to the scoped repository task with explicit validation evidence."
