# Lang typescript plan

Use this plan when you applying or updating the `lang-typescript` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `lang-typescript` skill.
...
- In: tasks covered by the `lang-typescript` skill and its resources.
...
- [ ] Use skill lang-typescript and linked resources.
...
- Example objective: "Apply the lang-typescript skill to the scoped repository task with explicit validation evidence."
