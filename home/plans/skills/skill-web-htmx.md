...
Use this plan when you applying or updating the `web-htmx` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `web-htmx` skill.
...
- In: tasks covered by the `web-htmx` skill and its resources.
...
- [ ] Use skill web-htmx and linked resources.
...
- Example objective: "Apply the web-htmx skill to the scoped repository task with explicit validation evidence."
