...
Use this plan when you applying or updating the `iac-ansible` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `iac-ansible` skill.
...
- In: tasks covered by the `iac-ansible` skill and its resources.
...
- [ ] Use skill iac-ansible and linked resources.
...
- Example objective: "Apply the iac-ansible skill to the scoped repository task with explicit validation evidence."
