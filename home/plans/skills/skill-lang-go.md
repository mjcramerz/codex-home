...
Use this plan when you applying or updating the `lang-go` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `lang-go` skill.
...
- In: tasks covered by the `lang-go` skill and its resources.
...
- [ ] Use skill lang-go and linked resources.
...
- Example objective: "Apply the lang-go skill to the scoped repository task with explicit validation evidence."
