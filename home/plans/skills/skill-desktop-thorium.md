# Desktop thorium plan

Use this plan when you applying or updating the `desktop-thorium` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `desktop-thorium` skill.
...
- In: tasks covered by the `desktop-thorium` skill and its resources.
...
- [ ] Use skill desktop-thorium and linked resources.
...
- Example objective: "Apply the desktop-thorium skill to the scoped repository task with explicit validation evidence."
