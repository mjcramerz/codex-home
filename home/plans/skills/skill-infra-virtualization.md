# Infra virtualization plan

Use this plan when you applying or updating the `infra-virtualization` skill. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when applying or updating the `infra-virtualization` skill.
...
- In: tasks covered by the `infra-virtualization` skill and its resources.
...
- [ ] Use skill infra-virtualization and linked resources.
...
- Example objective: "Apply the infra-virtualization skill to the scoped repository task with explicit validation evidence."
