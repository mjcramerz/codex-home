...
- `$CODEX_HOME/plans/index-and-routing.md` — Routing work
- `$CODEX_HOME/plans/docs-and-workflows.md` — Docs/workflow maintenance
- `$CODEX_HOME/plans/pack-overview.md` — Pack-wide changes
- `$CODEX_HOME/plans/templates-library.md` — Template work
- `$CODEX_HOME/plans/skills-library.md` — Skill-catalog work
<!-- END:contents -->
