...
Use this plan when you following `$CODEX_HOME/docs/workflows/auditd.md`. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when following `$CODEX_HOME/docs/workflows/auditd.md`.
...
- In: steps defined in the `auditd` workflow.
...
- [ ] Read `$CODEX_HOME/docs/workflows/auditd.md` and related references.
...
- Example objective: "Execute the auditd workflow for the current repository scope."
