# Vscode extensions plan

Use this plan when you following `$CODEX_HOME/docs/workflows/vscode-extensions.md`. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when following `$CODEX_HOME/docs/workflows/vscode-extensions.md`.
...
- In: steps defined in the `vscode-extensions` workflow.
...
- [ ] Read `$CODEX_HOME/docs/workflows/vscode-extensions.md` and related references.
...
- Example objective: "Execute the vscode-extensions workflow for the current repository scope."
