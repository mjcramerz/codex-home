...
Use this plan when you following `$CODEX_HOME/docs/workflows/terraform.md`. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.
...
- In: steps defined in the `terraform` workflow.
...
- [ ] Read `$CODEX_HOME/docs/workflows/terraform.md` and related references.
...
- Example objective: "Execute the terraform workflow for the current repository scope."
