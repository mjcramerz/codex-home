# Desktop entries plan

Use this plan when you following `$CODEX_HOME/docs/workflows/desktop-entries.md`. Fill in the concrete scope, evidence, ordered actions and completion criteria before executing dependent steps. Keep deployment and new test files out of scope unless the task authorizes them.

Use this plan when following `$CODEX_HOME/docs/workflows/desktop-entries.md`.
...
- In: steps defined in the `desktop-entries` workflow.
...
- [ ] Read `$CODEX_HOME/docs/workflows/desktop-entries.md` and related references.
...
- Example objective: "Execute the desktop-entries workflow for the current repository scope."
