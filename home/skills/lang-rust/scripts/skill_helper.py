#!/usr/bin/env python3
"""Utility helper for the lang-rust skill."""
...
SKILL_NAME = 'lang-rust'
SKILL_CATEGORY = 'LANG'
SKILL_DESCRIPTION = 'Build Rust workspaces with cargo fmt, clippy, locked builds, and targeted test guidance.'
...
REFERENCE_LINKS = [
  ...
  {
    "title": "https://doc.rust-lang.org/clippy/",
