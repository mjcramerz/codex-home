#!/usr/bin/env python3
"""Utility helper for the lang-perl skill."""
...
SKILL_NAME = 'lang-perl'
SKILL_CATEGORY = 'LANG'
SKILL_DESCRIPTION = 'Build Perl modules, hook handlers, and deterministic CLI helpers with strict validation and testing guidance.'
...
REFERENCE_LINKS = [
  ...
  {
    "title": "https://perldoc.perl.org/perlrun",
    "url": "https://perldoc.perl.org/perlrun",
    "note": "Primary reference."
  },
  {
    "title": "https://perldoc.perl.org/perlsec",
    "url": "https://perldoc.perl.org/perlsec",
    "note": "Primary reference."
  }
]
...
def cmd_validate() -> int:
    ...
    if not agent_path.is_file():
        ...
        try:
            if not has_filesystem_dependency(agent_path):
